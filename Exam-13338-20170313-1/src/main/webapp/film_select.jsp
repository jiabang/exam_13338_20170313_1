...
<body>
	...
	<table border="1" cellspacing="0" cellpadding="5" align="center">
		...
		<tr>
			...
			<td ><a href="${pageContext.request.contextPath}/film_update.jsp?id=<%= film.getFilm_id() %>" >修改</a></td>
			<td ><a href="${pageContext.request.contextPath}/film_delServlet?id=<%= film.getFilm_id() %>" >删除</a></td>
		</tr>
		<%} %>
